...
## 공통
- 반경: 버튼·입력·셀렉트·페이지네이션 **6**, 카드·다이얼로그 **10**, **배지(비인터랙티브) 4 · 칩/태그(인터랙티브) pill**, 체크/라디오 **4**, 배너 **12**, pill=full. *(2026-07-03 정정 — Badge/Tag 각 절과 정합, [07 모호점 ①](./07-changelog.md))*
- 폰트: label = 400. 제목/탭/아코디언 트리거 = 700. 보조 라벨·배지 **500** · 카드/패널 제목 **600** 허용 — synthetic weight 규약은 [01 굵기](./01-foundations.md) 참조.
